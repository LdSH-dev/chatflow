...
export default function MediaPreview({ media, isOwn }: MediaPreviewProps) {
  ...
  const renderImage = () => {
    if (imageError) {
      return (
        <div className="flex items-center justify-center w-full h-24 sm:h-32 bg-gray-100 rounded-lg">
    ...
    return (
      <div className="relative group cursor-pointer" onClick={() => setShowFullImage(true)}>
        ...
        <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-10 transition-all duration-200 rounded-lg flex items-center justify-center">
          <svg className="w-4 h-4 sm:w-6 sm:h-6 text-white opacity-0 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const renderDocument = () => {
    return (
      <a
        ...
        className="flex items-center space-x-2 sm:space-x-3 p-2 sm:p-3 border rounded-lg hover:bg-gray-50 transition-colors"
      >
